...
include('koneksi.php');
$ambil = $koneksi->query("SELECT * FROM barangkeluar WHERE idbarangkeluar='$_GET[id]'");
...
if (isset($_POST['simpan'])) {
    $koneksi->query("UPDATE barangkeluar SET idbarang='$_POST[idbarang]',noqr='$_POST[noqr]',peminjam='$_POST[peminjam]',tanggalkeluar='$_POST[tanggalkeluar]',namabarang='$_POST[namabarang]',jumlah='$_POST[jumlah]' WHERE idbarangkeluar='$_GET[id]'") or die(mysqli_error($koneksi));
