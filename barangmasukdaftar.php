            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-body">
                            <a class="btn btn-primary mb-3" href="barangmasuktambah.php" role="button">Tambah Barang Masuk</a>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="barangmasukedit.php?id=<?php echo $data['idbarangmasuk']; ?>" class="btn btn-success btn-sm m-1">Edit</a>
                                                    <a href="barangmasukhapus.php?id=<?php echo $data['idbarangmasuk']; ?>" class="btn btn-danger btn-sm m-1" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php } ?>
...
$no = 1;
while ($data = $ambildata->fetch_assoc()) {
    $ambil = $koneksi->query("SELECT * FROM barangmasuk WHERE idbarangmasuk='$data[idbarangmasuk]'");
