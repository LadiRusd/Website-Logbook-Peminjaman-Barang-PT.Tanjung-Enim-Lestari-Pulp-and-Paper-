                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" required class="form-control" name="tanggalkeluar" value="<?= date('Y-m-d') ?>" placeholder="Tanggal Masuk">
                                </div>
                                <div class="form-group">
...
if (isset($_POST['simpan'])) {
    ...
    $jumlah = $_POST['jumlah'];
    $koneksi->query("INSERT INTO barangkeluar(idbarang,noqr,peminjam,tanggalkeluar,namabarang,jumlah)
            VALUES ('$idbarang','$noqr','$peminjam','$tanggalkeluar','$namabarang','$jumlah')") or die(mysqli_error($koneksi));
