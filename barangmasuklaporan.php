                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover laporanbarangmasuk">
                                    ...
                                    <tbody>
                                        <?php
                                        if (isset($_POST['cari'])) {
                                            $ambildata = $koneksi->query("SELECT*FROM barangmasuk WHERE (tanggalmasuk >= '$tanggalawal' and tanggalmasuk <= '$tanggalakhir') order by idbarangmasuk desc");
                                        } else {
